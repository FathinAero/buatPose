...
// pilih menu sesuai mode sidebar
const navItems = computed(() => (mode.value === 'device' ? itemsDevice.value : itemsOrg.value))
</script>

<template>
  <aside class="w-[220px] border-r border-[#E5E7EB] flex flex-col bg-white">
    <!-- Vertical nav pakai komponen Nuxt UI v4 -->
    <UNavigationMenu
      :items="navItems"
